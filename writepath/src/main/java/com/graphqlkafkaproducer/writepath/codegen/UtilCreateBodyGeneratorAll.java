...
import com.graphqlkafkaproducer.writepath.models2.agreement.Types;
...
public class UtilCreateBodyGeneratorAll {

    private static final Logger logger = LoggerFactory.getLogger(UtilCreateBodyGeneratorAll.class);
...
*/
       inputObjects.put("InsuranceAgreement",Types.InsuranceAgreementCreateInput.class);
        inputObjects.put("InsuredObject",Types.InsuredObjectCreateInput.class);
        inputObjects.put("Coverage",Types.CoverageCreateInput.class);
...
/*        StringBuilder body = new StringBuilder();
        ...
        body.append( "   oneToMany.get(\""+utilClassNameConstant+"\").forEach(x->{\n");
     ...
     //   body2.append("//###################################################################\n");
        ...
        body2.append( "   manyToOne.get(\""+utilClassNameConstant+"\").forEach(x->{\n");
