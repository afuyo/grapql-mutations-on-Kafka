...
public class UtilPartyCreateWithoutChildOrganizationInput {
@Qualifier
...
@UtilPartyCreateWithoutChildOrganizationInput.Person
public Person person(Map<String, Object> in) {
return (Person)in.get("Person");
}
@UtilPartyCreateWithoutChildOrganizationInput.PartyName
